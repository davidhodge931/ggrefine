...
Similar to [`refine_modern()`](refine_modern.md), but keeps gridlines on
both axes when both are continuous or binned. A fusion between
[`refine_modern()`](refine_modern.md) and
[`refine_classic()`](refine_classic.md).
