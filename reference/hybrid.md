...
Behaves like [`classic()`](classic.md) when both axes are continuous or
binned — leaving gridlines and axis elements untouched. When a discrete
axis is present, behaves like [`modern()`](modern.md), removing
gridlines and axis line/tick elements from the non-focused dimension and
stripping ticks from the discrete axis.
