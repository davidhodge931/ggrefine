...
#'
#' @inheritParams refine_classic_keep
#'
#' @return A ggplot2 theme object
#' @export
refine_classic_drift <- function(
    ...,
    discrete,
    orientation = NULL
) {
