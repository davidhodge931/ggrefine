  ...
  theme <-
    ggplot2::theme(
      ...
      legend.ticks = ggplot2::element_line(
        ...
        linetype = legend_ticks_linetype
      ),
...
#' Grey theme
#'
#' @description A complete theme with a light grey panel background and white
#' panel grid colour. Uses flexoki inspired colours.
#'
