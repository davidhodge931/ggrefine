...
The main themes are `theme_white`, `theme_black`, `theme_oat` and `theme_silver`.
...
Some extras have been provided! These use the respective 50 shade from the flexoki palette for the panel background, and then apply a multiply blend of the colour with itself for the panel grid colour. 
