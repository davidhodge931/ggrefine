...
The premise is that it is useful to set themes that have all axis elements and all grid lines - and then adjust depending on the plot scale types and orientation. 
