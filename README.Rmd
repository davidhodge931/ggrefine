...
polish functions to tweak these easily based on the particulars of a plot.  
...
ggrefine provides a set of complete ggplot2 themes and theme polish functions. Themes control the overall look, while polish functions let you selectively remove gridlines, axis lines, and ticks based on the focus and type of each axis. The themes use the inky flexoki colours developed by Steph Ango. 
