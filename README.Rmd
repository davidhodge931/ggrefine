...
The themes are built to work with the refine functions - and can be customised easily. The `theme_greyer` function differs from the other two in that the `panel_grid_colour` by default is derived by applying a multiply blend on the `panel_background_fill`.
